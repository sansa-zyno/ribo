...
class RejectedSales extends StatefulWidget {
  RejectedSales({Key? key}) : super(key: key);

  @override
  State<RejectedSales> createState() => _RejectedSalesState();
}

class _RejectedSalesState extends State<RejectedSales> {
  List? tableDatas;

  getData() async {
    String username = await LocalStorage().getString("username");
    final table =
        await HttpService.post(Api.rejectedSales, {"username": username});
